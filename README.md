...
4. Preencha nível dinâmico, altura da caixa, vazão desejada, diâmetro e material da
   tubulação. O **comprimento da tubulação** já vem pré-preenchido com a distância do
   mapa e continua editável (a linha real quase nunca é reta).
...
velocidade, a sugestão de diâmetro, entradas inválidas e a distância haversine.
...
lib/calculo.ts         núcleo hidráulico — puro, candidato a virar API
